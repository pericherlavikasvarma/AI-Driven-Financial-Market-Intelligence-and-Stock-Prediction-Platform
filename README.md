...
```bash
git clone https://github.com/pericherlavikasvarma/AI-Driven-Financial-Market-Intelligence-and-Stock-Prediction-Platform
cd AI-Driven-Financial-Market-Intelligence-and-Stock-Prediction-Platform
```
